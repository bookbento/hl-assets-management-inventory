    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-2xl bg-white rounded-apple-lg shadow-2xl overflow-hidden"
            >
                    ...
                    <div className="mt-8 flex items-center justify-between p-4 bg-primary/5 rounded-xl border border-primary/10">
                        <div className="flex items-center gap-3">
                            ...
                            <p className="text-xs text-primary font-medium leading-tight text-left">
                                Adding assets will automatically update the inventory dashboard <br /> and notify the infrastructure team.
                            </p>
                        </div>
