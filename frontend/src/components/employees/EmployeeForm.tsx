                ...
                <form onSubmit={handleSubmit(submitHandler)} className="p-8">
                    <div className="space-y-5">
                        <div className="flex flex-col items-center justify-center mb-2">
                            <div className="w-16 h-16 rounded-full bg-[var(--surface-soft)] border-2 border-dashed border-[var(--border)] flex items-center justify-center text-[var(--muted-foreground)] mb-1 overflow-hidden">
                        ...
                        <div>
                            ...
                            {isOrgError && (
                                <div className="mb-2 p-2 rounded-lg border border-red-200 bg-red-50 dark:bg-red-500/10 dark:border-red-500/20 text-red-700 dark:text-red-300 text-xs">
