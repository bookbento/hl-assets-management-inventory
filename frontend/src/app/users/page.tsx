        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50/50 border-b border-[#D2D2D7]">
              <tr>
                <th className="text-left px-6 py-4 text-[11px] font-bold uppercase tracking-tight text-[#86868B]">
                  Name
                </th>
                <th className="text-left px-6 py-4 text-[11px] font-bold uppercase tracking-tight text-[#86868B]">
                  Department
                ...
                <th className="text-right px-6 py-4 text-[11px] font-bold uppercase tracking-tight text-[#86868B]">
                  Actions
                </th>
              </tr>
            </thead>
